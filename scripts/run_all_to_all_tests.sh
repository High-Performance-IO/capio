...
mpiexec -n 2 ../build/capio_process/capio 2 2 ../one_node_2_2.yaml > all_to_all_2_2_capio.txt &
sleep .1
...
mpiexec -n 2 ../build/capio_process/capio 4 2 ../one_node_2_4.yaml > all_to_all_2_4_capio.txt &
sleep .1
...
mpiexec -n 2 ../build/capio_process/capio 2 4 ../one_node_4_2.yaml > all_to_all_4_2_capio.txt &
sleep .1
