...
sleep .1
mpiexec -n 2 ../build/tests/collective/gather/gather_write ../one_node_2_2.yaml > gather_2_2_prods.txt
if [ $? -ne 0 ];
then
...
sleep .1
mpiexec -n 2 ../build/tests/collective/gather/gather_write ../one_node_2_4.yaml > gather_2_4_prods.txt
if [ $? -ne 0 ];
then
...
sleep .1
mpiexec -n 4 ../build/tests/collective/gather/gather_write ../one_node_4_2.yaml > gather_4_2_prods.txt
if [ $? -ne 0 ];
then
