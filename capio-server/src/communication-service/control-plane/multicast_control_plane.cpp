...
void MulticastControlPlane::multicast_server_aliveness_thread(const bool *continue_execution,
 ...
 void MulticastControlPlane::multicast_control_plane_incoming_thread(const bool *continue_execution) {
