...
void FSControlPlane::fs_server_aliveness_detector_thread(
...
FSControlPlane::FSControlPlane(int backend_port) : _backend_port(backend_port) {
    ...
    server_println(CAPIO_LOG_SERVER_CLI_LEVEL_WARNING, "FSControlPlane initialization completed.");
};
...
void FSControlPlane::notify_all(FSControlPlane::event_type event,
