...
void read_from_file(const std::string file_name, int* data, long int num_elements, long int num_reads, int rank) {
...
int main (int argc, char** argv) {
	...
	read_from_file(file_name, data, num_elements, num_reads, rank);
