...
void test_one_to_one(const std::string &buffer_name, long int buff_size, long int num_elems,
...
void test_one_to_one_str(const std::string &buffer_name, long int buff_size, long int num_elems,
                         int rank, sem_t *sem_prod, sem_t *sem_cons) {
