...
int fchown_handler(long arg0, long arg1, long arg2,long arg3, long arg4, long
arg5, long* result,long tid){

    int res = capio_fchown(static_cast<int>(arg0),
static_cast<uid_t>(arg1),static_cast<gid_t>(arg2)); if (res != -2) { *result =
(res < 0 ? -errno : res); return 0;
    }
    return 1;
}
*/
