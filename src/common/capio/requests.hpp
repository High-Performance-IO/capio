...
constexpr const int CAPIO_REQUEST_HANDSHAKE      = 5;
constexpr const int CAPIO_REQUEST_MKDIR          = 6;
constexpr const int CAPIO_REQUEST_OPEN           = 7;
constexpr const int CAPIO_REQUEST_READ           = 8;
constexpr const int CAPIO_REQUEST_RENAME         = 9;
constexpr const int CAPIO_REQUEST_WRITE          = 10;
constexpr const int CAPIO_REQUEST_QUERY_MEM_FILE = 11;
