...
extern std::unordered_map<std::string, std::pair<const char *const, off64_t>> files_location;
extern std::mutex files_location_mutex;

extern int files_location_fd;
extern FILE *files_location_fp;
extern std::unordered_map<std::string, FILE *> files_location_fps;
